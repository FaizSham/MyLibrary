        ...
        <div className="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56 border-border" align="end" forceMount>
                ...
                <DropdownMenuItem className="text-foreground hover:bg-accent">Profile</DropdownMenuItem>
                <DropdownMenuItem className="text-foreground hover:bg-accent">Settings</DropdownMenuItem>
                <DropdownMenuSeparator className="bg-border" />
                <DropdownMenuItem className="text-foreground hover:bg-accent">Log out</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
        </div>
      </header>
